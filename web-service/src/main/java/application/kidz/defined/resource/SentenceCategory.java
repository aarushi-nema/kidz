...
import platform.db.*;
import java.util.*;
import application.kidz.defined.message.*;
 ...
 * 
 */
public class SentenceCategory extends BaseResource {
	...
	public static String FIELD_SENTENCES = "sentences";
	public static String FIELD_CREATION_TIME = "creation_time";
	public static String FIELD_EXTRA_DATA = "extra_data";

	private static final long serialVersionUID = 1L;
	public final static ResourceMetaData metaData = new ResourceMetaData("sentence_category");
	...
	static {
		...
		Field sentencesField = new Field("sentences", "Array");
		sentencesField.setValueType("String");
		metaData.addField(sentencesField);
		...
		metaData.setTableName("sentence_category");

		metaData.setCluster("DB_PROFILE");
	}

	public SentenceCategory() {this.setId(Util.getUniqueId());}
	public SentenceCategory(String id) {this.setId(id);}

	public SentenceCategory(SentenceCategory obj) {
		this.id = obj.id;
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		sentences = (List<String>) map.get("sentences");
	...
	public void addSentences(String value) {
		if(sentences == null)
	...
	public  Class<?> getResultClass() {return SentenceCategoryResult.class;};
	public  Class<?> getMessageClass() {return SentenceCategoryMessage.class;};
	public  Class<?> getHelperClass() {return SentenceCategoryHelper.class;};
	public  Class<?> getServiceClass() {return SentenceCategoryService.class;};
}