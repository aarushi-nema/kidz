 ...
 * 
 */
public class SentenceType extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("sentence_type");
	...
	static {
		...
		metaData.setTableName("sentence_type");

		metaData.setCluster("DB_PROFILE");
	}

	public SentenceType() {this.setId(Util.getUniqueId());}
	public SentenceType(String id) {this.setId(id);}

	public SentenceType(SentenceType obj) {
		this.id = obj.id;
	...
	public  Class<?> getResultClass() {return SentenceTypeResult.class;};
	public  Class<?> getMessageClass() {return SentenceTypeMessage.class;};
	public  Class<?> getHelperClass() {return SentenceTypeHelper.class;};
	public  Class<?> getServiceClass() {return SentenceTypeService.class;};
}