 ...
 * 
 */
public class WordFamily extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("word_family");
	...
	static {
		...
		Field rootField = new Field("root", "String");
		rootField.setLength(1);
		metaData.addField(rootField);
		...
		metaData.setTableName("word_family");

		metaData.setCluster("DB_PROFILE");
	}

	public WordFamily() {this.setId(Util.getUniqueId());}
	public WordFamily(String id) {this.setId(id);}

	public WordFamily(WordFamily obj) {
		this.id = obj.id;
	...
	public  Class<?> getResultClass() {return WordFamilyResult.class;};
	public  Class<?> getMessageClass() {return WordFamilyMessage.class;};
	public  Class<?> getHelperClass() {return WordFamilyHelper.class;};
	public  Class<?> getServiceClass() {return WordFamilyService.class;};
}