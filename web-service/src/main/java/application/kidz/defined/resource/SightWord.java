 ...
 * 
 */
public class SightWord extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("sight_word");
	...
	static {
		...
		metaData.setTableName("sight_word");

		metaData.setCluster("DB_PROFILE");
	}

	public SightWord() {this.setId(Util.getUniqueId());}
	public SightWord(String id) {this.setId(id);}

	public SightWord(SightWord obj) {
		this.id = obj.id;
	...
	public  Class<?> getResultClass() {return SightWordResult.class;};
	public  Class<?> getMessageClass() {return SightWordMessage.class;};
	public  Class<?> getHelperClass() {return SightWordHelper.class;};
	public  Class<?> getServiceClass() {return SightWordService.class;};
}