 ...
 * 
 */
public class WordFamilyWord extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("word_family_word");
	...
	static {
		...
		Field familyField = new Field("family", "String");
		familyField.setLength(1);
		metaData.addField(familyField);
		...
		metaData.setTableName("word_family_word");

		metaData.setCluster("DB_PROFILE");
	}

	public WordFamilyWord() {this.setId(Util.getUniqueId());}
	public WordFamilyWord(String id) {this.setId(id);}

	public WordFamilyWord(WordFamilyWord obj) {
		this.id = obj.id;
	...
	public  Class<?> getResultClass() {return WordFamilyWordResult.class;};
	public  Class<?> getMessageClass() {return WordFamilyWordMessage.class;};
	public  Class<?> getHelperClass() {return WordFamilyWordHelper.class;};
	public  Class<?> getServiceClass() {return WordFamilyWordService.class;};
}