 ...
 * 
 */
public class SightWordCategory extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("sight_word_category");
	...
	static {
		...
		metaData.setTableName("sight_word_category");

		metaData.setCluster("DB_PROFILE");
	}

	public SightWordCategory() {this.setId(Util.getUniqueId());}
	public SightWordCategory(String id) {this.setId(id);}

	public SightWordCategory(SightWordCategory obj) {
		this.id = obj.id;
	...
	public  Class<?> getResultClass() {return SightWordCategoryResult.class;};
	public  Class<?> getMessageClass() {return SightWordCategoryMessage.class;};
	public  Class<?> getHelperClass() {return SightWordCategoryHelper.class;};
	public  Class<?> getServiceClass() {return SightWordCategoryService.class;};
}