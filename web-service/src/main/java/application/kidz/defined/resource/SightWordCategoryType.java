 ...
 * 
 */
public class SightWordCategoryType extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("sight_word_category_type");
	...
	static {
		...
		metaData.setTableName("sight_word_category_type");

		metaData.setCluster("DB_PROFILE");
	}

	public SightWordCategoryType() {this.setId(Util.getUniqueId());}
	public SightWordCategoryType(String id) {this.setId(id);}

	public SightWordCategoryType(SightWordCategoryType obj) {
		this.id = obj.id;
	...
	public  Class<?> getResultClass() {return SightWordCategoryTypeResult.class;};
	public  Class<?> getMessageClass() {return SightWordCategoryTypeMessage.class;};
	public  Class<?> getHelperClass() {return SightWordCategoryTypeHelper.class;};
	public  Class<?> getServiceClass() {return SightWordCategoryTypeService.class;};
}