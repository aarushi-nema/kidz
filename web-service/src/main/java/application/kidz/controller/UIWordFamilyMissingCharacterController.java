...
@Controller
public class UIWordFamilyMissingCharacterController {
    @Autowired
    private HttpServletRequest request;

    @RequestMapping(value ="/word_family_missing_character",method = RequestMethod.GET)
    public @ResponseBody String doGet(@CookieValue(value="session_id",required=false) String sessionId,
        ...
        try {
            ...
            WordFamilyMissingCharacterServlet servlet = new WordFamilyMissingCharacterServlet();
