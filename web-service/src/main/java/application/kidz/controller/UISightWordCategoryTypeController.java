...
import application.kidz.servlet.SightWordCategoryTypeServlet;
import application.kidz.servlet.WordFamilyServlet;
...
@Controller
public class UISightWordCategoryTypeController {
    @Autowired
    private HttpServletRequest request;

    @RequestMapping(value ="/sight_word_category_type",method = RequestMethod.GET)
    public @ResponseBody String doGet(@CookieValue(value="session_id",required=false) String sessionId,
        ...
        try {
            ...
            SightWordCategoryTypeServlet servlet = new SightWordCategoryTypeServlet();
