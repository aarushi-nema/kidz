...
import application.kidz.servlet.WordFamilyMissingCharacterServlet;
import application.kidz.servlet.WordFamilyRecognizeServlet;
...
@Controller
public class UIWordFamilyWordRecognizeController {
    @Autowired
    private HttpServletRequest request;

    @RequestMapping(value ="/word_family_word_recognize",method = RequestMethod.GET)
    public @ResponseBody String doGet(@CookieValue(value="session_id",required=false) String sessionId,
        ...
        try {
            ...
            WordFamilyRecognizeServlet servlet = new WordFamilyRecognizeServlet();
