...
import application.kidz.servlet.MyAreaAnalysisServlet;
...
@Controller
public class UIAnalysisController {
    @Autowired
    private HttpServletRequest request;

    @RequestMapping(value ="/ui/analysis",method = RequestMethod.GET)
    public @ResponseBody String doGet(@CookieValue(value="session_id",required=false) String sessionId,
        ...
        try {
            ...
            MyAreaAnalysisServlet servlet = new MyAreaAnalysisServlet();
