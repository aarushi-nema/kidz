...
import application.kidz.servlet.SightWordRecognizeServlet;
...
@Controller
public class UISightWordRecognizeController {
    @Autowired
    private HttpServletRequest request;

    @RequestMapping(value ="/sight_word_recognize",method = RequestMethod.GET)
    public @ResponseBody String doGet(@CookieValue(value="session_id",required=false) String sessionId,
        ...
        try {
            ...
            SightWordRecognizeServlet servlet = new SightWordRecognizeServlet();
