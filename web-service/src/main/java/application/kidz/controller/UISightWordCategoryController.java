...
@Controller
public class UISightWordCategoryController {
    @Autowired
    private HttpServletRequest request;

    @RequestMapping(value ="/sight_word_category",method = RequestMethod.GET)
    public @ResponseBody String doGet(@CookieValue(value="session_id",required=false) String sessionId,
        ...
        try {
            ...
            SightWordCategoryServlet servlet = new SightWordCategoryServlet();
