...
import application.kidz.servlet.SentenceReadServlet;
...
@Controller
public class UISentenceReadController {
    @Autowired
    private HttpServletRequest request;

    @RequestMapping(value ="/sentence_read",method = RequestMethod.GET)
    public @ResponseBody String doGet(@CookieValue(value="session_id",required=false) String sessionId,
        ...
        try {
            ...
            SentenceReadServlet servlet = new SentenceReadServlet();
