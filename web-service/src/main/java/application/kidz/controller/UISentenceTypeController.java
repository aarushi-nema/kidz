...
import application.kidz.servlet.SentenceTypeServlet;
...
@Controller
public class UISentenceTypeController {
    @Autowired
    private HttpServletRequest request;

    @RequestMapping(value ="/sentence_type",method = RequestMethod.GET)
    public @ResponseBody String doGet(@CookieValue(value="session_id",required=false) String sessionId,
        ...
        try {
            ...
            SentenceTypeServlet servlet = new SentenceTypeServlet();
