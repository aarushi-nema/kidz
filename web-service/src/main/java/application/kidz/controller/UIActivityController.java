...
import application.kidz.servlet.MyAreaActivityServlet;
...
public class UIActivityController {
    ...
    @RequestMapping(value ="/ui/activity",method = RequestMethod.GET)
    public @ResponseBody String doGet(@CookieValue(value="session_id",required=false) String sessionId,
        ...
        try {
            ...
            MyAreaActivityServlet servlet = new MyAreaActivityServlet();
